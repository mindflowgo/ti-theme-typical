        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row g-0 w-100">
                    <div class="col-sm-4">
                        <div class="typical-quantity" data-toggle="quantity">
                            <button
                                class="btn btn-light"
                                data-operator="minus"
                                type="button"
                    ...
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-primary btn-lg text-uppercase w-100" data-attach-loading>
                            <div class="d-flex align-items-center">
                                <i class="poco-icon-shopping-basket"></i>
